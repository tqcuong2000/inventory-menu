...
public class DataManager {
    ...
    public void register() {
        ResourceLoader.get(PackType.SERVER_DATA).registerReloadListener(Identifier.fromNamespaceAndPath(InventoryMenu.MOD_ID, "menu_data_manager"), this.menus());
        ResourceLoader.get(PackType.SERVER_DATA).registerReloadListener(Identifier.fromNamespaceAndPath(InventoryMenu.MOD_ID, "item_menu_data_manager"), this.items());
    }
}
